...
logs_path = './cnnlstm'
writer = SummaryWriter('{}/logs'.format(logs_path), flush_secs=1000)
...
if __name__ == "__main__":
    ...
    train_dataset, test_dataset = NYCSTDNDataset(data_path='data/train.npz.npy'), \
                                  NYCSTDNDataset(data_path='data/test.npz.npy')
    ...
    for i in range(args.epochs):
        ...
        writer.add_scalar("train_lost", train_loss, i)
